...
public class Configurator {
    ...
    public Configurator() {
        ...
        this.setDoubleProperty("bandgraph_peakfootconstant", .75); //0.75
        ...
        // CARSNAPSHOTGRAPH
        this.setDoubleProperty("carsnapshotgraph_peakfootconstant", .55); //0.55
        ...
        this.setIntProperty("char_normalizeddimensions_x", 18); //8
        this.setIntProperty("char_normalizeddimensions_y", 3); //13
        ...
        this.setDoubleProperty("plategraph_rel_minpeaksize", 0.85); // 0.85 // mensie cislo seka znaky, vacsie zase nespravne zdruzuje
        ...
        this.setIntProperty("intelligence_numberOfChars",3);
        ...
        this.setDoubleProperty("intelligence_maxSaturationCostDispersion", .15); //0.15
