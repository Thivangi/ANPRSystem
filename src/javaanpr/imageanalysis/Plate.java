...
public class Plate extends Photo {
    ...
    public Plate(BufferedImage bi,int xin,int yin, int width, int height) {
        super(bi);
        this.plateCopy = new Plate(duplicateBufferedImage(this.image), true);
        this.plateCopy.adaptiveThresholding();
        this.x=xin;
   ...
   BufferedImage bi2 =bi;
    File outputfile = new File("C:\\Users\\Godfather\\Desktop\\ANPRimages\\saved7.jpg");
    ImageIO.write(bi2, "jpg", outputfile);
    BufferedImage bi3 =image;
    File outputfile2 = new File("C:\\Users\\Godfather\\Desktop\\ANPRimages\\saved8.jpg");
    ImageIO.write(bi3, "jpg", outputfile2);
         }
    catch (IOException e) {
}*/
    }
    ...
    public Vector<Char> getChars() {
        ...
        for (int i=0; i<peaks.size(); i++) {
            ...
            //System.out.println("p = "+p.getLeft());
            ...
            /*try {
    // retrieve image
   BufferedImage bi2 =image;
    File outputfile = new File("C:\\Users\\Godfather\\Desktop\\ANPRimages\\saved17.jpg");
    ImageIO.write(bi2, "jpg", outputfile);
    ...
    public Plate clone() {
        return new Plate(this.duplicateBufferedImage(this.image),x,y,h,w);
    }   
    ...
    public void verticalEdgeDetector(BufferedImage source) {
       ...
       /* try {
    // retrieve image
   BufferedImage bi2 =destination;
    File outputfile = new File("C:\\Users\\Godfather\\Desktop\\ANPRimages\\saved11.jpg");
    ImageIO.write(bi2, "jpg", outputfile);
    BufferedImage bi3 =source;
    File outputfile2 = new File("C:\\Users\\Godfather\\Desktop\\ANPRimages\\saved12.jpg");
    ImageIO.write(bi3, "jpg", outputfile2);
         }
    catch (IOException e) {
}*/
    ...
    public void horizontalEdgeDetector(BufferedImage source) {
        ...
        /*try {
    // retrieve image
   BufferedImage bi2 =source;
    File outputfile = new File("C:\\Users\\Godfather\\Desktop\\ANPRimages\\saved9.jpg");
    ImageIO.write(bi2, "jpg", outputfile);
    BufferedImage bi3 =destination;
    File outputfile2 = new File("C:\\Users\\Godfather\\Desktop\\ANPRimages\\save10.jpg");
    ImageIO.write(bi3, "jpg", outputfile2);
         }
    catch (IOException e) {
}*/
