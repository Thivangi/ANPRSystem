...
import javaanpr.intelligence.Intelligence;
    ...
    public class BandGraph extends Graph {/* TODO - BEGIN */
        ...
        public BandGraph(Band handle) {
            this.handle = handle; // bears link to this image ( band ) on which the chart applies
        }
        ...
        public Vector<Peak> findPeaks(int count) {
            ...
            for (int c=0; c<count; c++) { // for count
                ...
                for (int i=0; i<this.yValues.size(); i++) { // zlava doprava
                    if (allowedInterval(outPeaks, i)) { //If a potential peak is in "free " interval , which does not fall within the other peaks
                ...
                // We found najvacsi peak // do 1. Punching
        ...
        public int indexOfLeftPeakAbs(int peak, double peakFootConstantAbs) {
            ...
            System.out.println("z = "+Math.max(0,index));
