...
//            Main.configurator.getIntProperty("carsnapshot_projectionresize_y");
    ...
    public Vector<Band> getBands() {
        ...
        for (int i=0; i<peaks.size(); i++) {
         ...
         out.add(new Band(
         image.getSubimage(  0  ,(int) (p.getLeft())  ,  image.getWidth() , (int) (p.getDiff()  )),0,(int) (p.getLeft())
                  )
                    );
            /*if(i==0)
            {
           try { 
    // retrieve image
    System.out.println("p.getLeft(0) = "+p.getLeft());
    BufferedImage bi =image.getSubimage(  0  ,(int) (p.getLeft())  ,  image.getWidth() , (int) (p.getDiff()  ));
    File outputfile = new File("C:\\Users\\Godfather\\Desktop\\ANPRimages\\getBands\\saved22.jpg");
     ImageIO.write(bi, "jpg", outputfile);
           ...
           try { 
    // retrieve image
               System.out.println("p.getLeft(1) = "+p.getLeft());
   BufferedImage bi =image.getSubimage(  0  ,(int) (p.getLeft())  ,  image.getWidth() , (int) (p.getDiff()  ));
    File outputfile = new File("C:\\Users\\Godfather\\Desktop\\ANPRimages\\getBands\\saved23.jpg");
    ImageIO.write(bi, "jpg", outputfile);
         }
 catch (IOException e) {
        }
           ...
           try { 
    // retrieve image
               System.out.println("p.getLeft(2) = "+p.getLeft());
   BufferedImage bi =image.getSubimage(  0  ,(int) (p.getLeft())  ,  image.getWidth() , (int) (p.getDiff()  ));
    File outputfile = new File("C:\\Users\\Godfather\\Desktop\\ANPRimages\\getBands\\saved24.jpg");
    ImageIO.write(bi, "jpg", outputfile);
         }
 catch (IOException e) {
        }
   ...
   BufferedImage bi2 = image;
    File outputfile = new File("C:\\Users\\Godfather\\Desktop\\saved4.jpg");
