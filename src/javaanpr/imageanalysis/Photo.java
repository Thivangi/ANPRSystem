...
public class Photo {
    ...
    public void loadImage(String filepath) throws IOException {
        try {
          ...
          /*  try {
    // retrieve image
   BufferedImage bi2 =outimage;
    File outputfile = new File("C:\\Users\\Godfather\\Desktop\\ANPRimages\\saved13.jpg");
   ...
   BufferedImage bi2 =bi;
    File outputfile = new File("C:\\Users\\Godfather\\Desktop\\saved20.jpg");
    ImageIO.write(bi2, "jpg", outputfile);
         }
 catch (IOException e) {
}*/
   ...
   BufferedImage bi2 =source;
    File outputfile = new File("C:\\Users\\Godfather\\Desktop\\ANPRimages\\saved14.jpg");
    ImageIO.write(bi2, "jpg", outputfile);
    BufferedImage bi3 =destination;
    File outputfile2 = new File("C:\\Users\\Godfather\\Desktop\\ANPRimages\\saved15.jpg");
    ...
    public void adaptiveThresholding() { // only use this feature should be in the constructor Model 
