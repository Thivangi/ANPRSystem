...
import static javaanpr.Main.im;
...
public class Intelligence {
    ...
    public String recognize(CarSnapshot carSnapshot) throws Exception {
        ...
        if (enableReportGeneration) {
            ...
            //System.out.println("x = " +carSnapshot.getWidth());
    ...
    BufferedImage bi =p.image;
    File outputfile = new File("C:\\Users\\Godfather\\Desktop\\ANPRimages\\getBands\\saved31.jpg");
     ImageIO.write(bi, "jpg", outputfile);
               ...
               // System.out.println("X ="+x);
                ...
                //System.out.println("W ="+plate.getw());
                
                for(int i=0;i<1;i++)
                {
                y-=10;
                int rgba = p.image.getRGB(x,y);
    ...
    public RGB recognize(int R,int G,int B){
        RGB obj = new RGB(r,g,b1);
        return obj;
    }
