    ...
    public class RecognizeThread extends Thread{
        ...
        { 
            ...
            try {
                ...
                Intellobj.recognize(r,g,b);
                time = Long.toString(totalTime);
                FileOutputStream fout = new FileOutputStream("out.txt",true) ;
                fout.write(recognizedText.getBytes()) ;
                imageProp = ImageUtils.getJpegProperties(new File(this.parentFrame.fileListModel.fileList.elementAt(index).fullPath));
                String text = "\t"+time+ "msss\t" +imageProp+ "aaab\t" +r+ "\t" +g+ "\t" +b; ;  
            ...
            //----
            //System.out.println(this.parentFrame.fileListModel.fileList.elementAt(index).fullPath);
...
//                    String query = "INSERT into ANPR VALUES(DEFAULT,'" + recognizedText + "','" + time+ "','" + imageProp +"')";
...
//                }
    ...
    private void initComponents() {
        ...
        imageFileFilter1 = new javaanpr.gui.tools.ImageFileFilter();
...
//            this.label.setText(plate);
    ...
    private javaanpr.gui.tools.ImageFileFilter imageFileFilter1;
